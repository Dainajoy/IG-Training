...
public class CountEmployeeInEachDepartment {
    public static void main(String[] args) {
        ...
        System.out.println("Employess in each department");
        Map<String,Long>empCountInEachDept=emplist.stream().collect(Collectors.groupingBy(Employee::getDepartment,Collectors.counting()));
