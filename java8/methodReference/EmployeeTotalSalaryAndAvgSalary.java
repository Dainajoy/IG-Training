...
public class EmployeeTotalSalaryAndAvgSalary {
    public static void main(String[] args) {
        ...
        DoubleSummaryStatistics salarySatistics = emplist.stream().collect(Collectors.summarizingDouble(Employee::getSalary));
        System.out.println("Average salary of employees:" + salarySatistics.getAverage());
        System.out.println("Total salary of employees:" + salarySatistics.getSum());
